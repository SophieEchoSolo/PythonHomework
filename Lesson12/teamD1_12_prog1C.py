...
Description:  teamD1_12_prog1C.py - This program will choose a letter and will find the words starting with that letter regardless of case
"""
...
for word in wordList:
    word = word.lower()
    if word[0] == fletter.lower():
        firstletter.append(word)
print(
    f"The following list shows all words starting with the letter {fletter}: \n")
print(firstletter)
