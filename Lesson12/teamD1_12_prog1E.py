...
Description:  teamD1_12_prog1E.py - This program will choose a letter and will find the words that contain that letter regardless of case
"""
...
containsLetter = []
findLetter = input(
    "Choose a letter and I will find the words that contain that letter regardless of case: ")
